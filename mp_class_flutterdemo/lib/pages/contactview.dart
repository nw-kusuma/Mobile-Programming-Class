...
import '../components/models/contacts.dart';
        ...
        return Card(
          ...
          child: ListTile(
            leading: CircleAvatar(
              ...
              child: Icon(Icons.people, color: Theme.of(context).primaryColorLight),
            ),
            title: Text(name, 
    ...
    return Column(
      ...
      children: [
        CircleAvatar(radius: 75.0,
          backgroundColor: Theme.of(context).primaryColorDark,
          foregroundImage: AssetImage('assets/images/circle_profile.png'),
        ),
